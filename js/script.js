(function () {
	...
	SNOOP.findDiff = function (matchedBoard) {
	...
	MATCH.STATE.updateData = function (matchedBoard, cardID) {
		var updatedBoard;
	...
	// DELETE THIS ------------------------------------------------------
	MATCH.STATE.updateDataBACKUP = function (matchedBoard, cardID) {
		var updatedBoard;
		matchedBoard[cardID].active = true;
		matchedBoard[cardID].found = true;
		updatedBoard = matchedBoard;
